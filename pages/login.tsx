        ...
        <Card className="shadow-sm border border-gray-200 rounded-xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full text-sm py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-md"
                disabled={isLoading}
              >
              ...
              <div className="flex justify-between text-xs pt-1">
                <button
                  ...
                  onClick={() => router.push("/verification-mail")}
                >
                  Forgot Password?
                </button>
                <button
            ...
            <div className="mt-5 p-3 bg-gray-100 rounded-lg border border-gray-200">
              <p className="text-xs text-gray-700 mb-1 font-semibold">Demo Credentials:</p>
